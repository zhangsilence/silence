package com.lemon.silence.common;
...
public class Constants {
	...
	/**SWAGGER地址*/
	public static final String SWAGGER_ADDRESS = "http://localhost:8888/swagger-ui.html";
	/**
	 * 日期时间格式
	 */
	 ...
	 * 系统前缀
	 */
	public static final String EXCEPTION_PREFIX = "Lemon";
